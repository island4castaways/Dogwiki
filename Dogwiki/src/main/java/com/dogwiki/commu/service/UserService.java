...
public class UserService {
	...
	@Autowired
	private UserRepository repository;  //실제 Entity 작업하는 객체
	  ...
	  //사용자 생성
	   public UserEntity create(final UserEntity userEntity) {
	      ...
	      return repository.save(userEntity); //사용자 저장 및 결과 반환...
	   }
	   
	   //사용자 인증(존재여부.로그인)
	   public UserEntity getByCredentials(final String userid, final String password) {
	      return repository.findByUseridAndPw(userid, password);
	   }
	   //id로 entity객체 반환
