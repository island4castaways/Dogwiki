...
<section style="margin-top: 150px;">
   ...
   <section class="article-detail table-common con row"
      ...
      <h2 style="margin-bottom: 15px; ">게시판 글작성 페이지</h2>
      ...
      <table class="cell" border="1">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td></td>
               <td></td>
               <td><input style="width: 208px"  type="file" name="file"></td>
            </tr>
      </table>
      
       <!-- 글 등록 메뉴 -->
      
      <input type = "hidden" name ="category" value="${param.category}" style=" margin-bottom: 20px;">
               <div class="write-brn" >
